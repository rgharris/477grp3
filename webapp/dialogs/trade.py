...
if len(pairs) == 0:
	...
	if pairs.has_key("invalid"):
		...
		output = output + "<input type=\"hidden\" value=\"" + str(tradeInfo['from']) + "\" name=\"from\"><input type=\"submit\" value=\"Yes I do!\" class=\"bottom half left\" name=\"confirmTrade\"/><input type=\"submit\" value=\"No I don't!\" class=\"bottom half right\" name=\"doNotTrade\"/></form>"
		jsonInfo.close()
