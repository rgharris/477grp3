...
/*
#define SPI_MOSI_PIN			AVR32_SPI_MISO_0_2_PIN
#define SPI_MOSI_FUNCTION		AVR32_SPI_MISO_0_2_FUNCTION
#define SPI_MISO_PIN			AVR32_SPI_MOSI_0_0_PIN
#define SPI_MISO_FUNCTION		AVR32_SPI_MOSI_0_0_FUNCTION
*/
